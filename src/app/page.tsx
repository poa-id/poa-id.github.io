            ...
            <section className="w-full lg:w-4/5 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-base text-muted-foreground font-light">
                  ...
                  My focus is figuring out which problem actually needs solving — then building the system and interface <span className="font-medium">that solves it</span>.
                </p>
                <p className="text-base text-muted-foreground font-light">
                  Outside of that, I make things — illustration, tattoos, anything I can get my hands on. Let's talk!
                </p>
              </div>
              <Link 
                href="/work" 
